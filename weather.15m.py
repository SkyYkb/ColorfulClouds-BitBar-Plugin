...
def get_wx():
  ...
  try:
    ...
    if 'forecast_keypoint' in wx:
      weather_data['condition'] = str(wx['forecast_keypoint'].encode('utf-8'))
...
def render_wx():
  ...
  if 'city' in weather_data and 'region' in weather_data:
    print (weather_data['city'] + ', ' + weather_data['region'] + ' | href=http://caiyunapp.com/map/#' + weather_data['loc'])
  elif 'country' in weather_data:
    print (weather_data['country'] + ' | href=http://caiyunapp.com/map/#' + weather_data['loc'])
